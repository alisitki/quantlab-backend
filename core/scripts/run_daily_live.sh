...
#
# Cron example:
#   0 2 * * * /home/deploy/quantlab/api/core/scripts/run_daily_live.sh >> /home/deploy/quantlab/api/core/logs/cron_daily.log 2>&1

set -uo pipefail

WORKDIR="/home/deploy/quantlab/api/core"
