...
### `linkusdt`
- `verdict=INVALID_RUN`
- `reason=observe_only_unsupported_by_strategy_contract`
...
- `stop_reason=observe_only_unsupported_by_strategy_contract`
...
- `final_recommendation=NEITHER_ADVANCE`
- `stop_condition=INVALID_LANE`
## Next Phase
- OBSERVE_ONLY is not supported by the current ReturnReversalV1 runtime contract; resolve posture-vs-contract in a separate sprint before retrying this lane.
