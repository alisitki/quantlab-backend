...
RUN_ROOT="$OUTPUT_ROOT/full_linkusdt_rerun"
...
TIME_LOG="$EVIDENCE_ROOT/0002_observability_rerun_time.log"
STDOUT_LOG="$EVIDENCE_ROOT/0002_observability_rerun_stdout.log"
STDERR_LOG="$EVIDENCE_ROOT/0002_observability_rerun_stderr.log"
...
cat >"$WATCHLIST_JSON" <<'JSON'
{
  ...
  "governance": {
    "surface_role": "TASK_LOCAL_LINKUSDT_OBSERVABILITY_RERUN",
    "authoritative_scope": "Single-strategy task-local microstructure rerun only.",
